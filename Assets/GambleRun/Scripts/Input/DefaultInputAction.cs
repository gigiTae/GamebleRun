...
//     version 1.17.0
//     from Assets/GambleRun/Input/DefaultInputAction.inputactions
//
...
{
    /// <summary>
    /// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/GambleRun/Input/DefaultInputAction.inputactions".
    /// </summary>
    /// <remarks>
    ...
    ""controlSchemes"": []
        ...
        ~@DefaultInputAction()
        {
            UnityEngine.Debug.Assert(!m_GamePlay.enabled, "This will cause a leak and performance issues, DefaultInputAction.GamePlay.Disable() has not been called.");
            UnityEngine.Debug.Assert(!m_Inventory.enabled, "This will cause a leak and performance issues, DefaultInputAction.Inventory.Disable() has not been called.");
        }
        ...
        public struct InventoryActions
        {
            ...
            /// Construct a new instance of the input action map wrapper class.
            /// </summary>
            public InventoryActions(@DefaultInputAction wrapper) { m_Wrapper = wrapper; }
            /// <summary>
