...
namespace GambleRun.Persistence
{
    ...
    public class SaveLoadManager : Singleton<SaveLoadManager>
    {
        ...
        {
            _gameData.Player = Bind<PlayerBinder, PlayerData>(_gameData.Player);

            _gameData.Storages = Bind<StorageDataBinder, StorageData>(_gameData.Storages);
        }
        ...
        {
            _gameData = _dataService.Load<GameData>(fileName);
